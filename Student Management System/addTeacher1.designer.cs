...
namespace Student_Management_System
{
	...
	public partial class addTeacherDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertaddTeacher(addTeacher instance);
    partial void UpdateaddTeacher(addTeacher instance);
    partial void DeleteaddTeacher(addTeacher instance);
    #endregion
		
		public addTeacherDataContext() : 
				base(global::Student_Management_System.Properties.Settings.Default.StudentManagementConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public addTeacherDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public addTeacherDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public addTeacherDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public addTeacherDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<addTeacher> addTeachers
		{
			get
			{
				return this.GetTable<addTeacher>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.addTeacher")]
	public partial class addTeacher : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnsubjectKeyChanging(string value);
    partial void OnsubjectKeyChanged();
    ...
    partial void OngradeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_subjectKey", DbType="VarChar(50)")]
		public string subjectKey
		{
			...
			set
			{
				if ((this._subjectKey != value))
				{
					this.OnsubjectKeyChanging(value);
					this.SendPropertyChanging();
					this._subjectKey = value;
					this.SendPropertyChanged("subjectKey");
					this.OnsubjectKeyChanged();
				}
			}
		}
